...
class IUIAutomationElement
{
	...
	;	CreateNotCondition(condition)
	;	CreateOrConditionFromNativeArray(conditions)
	;	CreateOrConditionFromArray(conditions)
	;	CreateOrCondition(condition1,condition2)
	;	CreateAndConditionFromNativeArray(conditions)
	;	CreateAndConditionFromArray(conditions)
	;	CreateAndCondition(condition1,condition2)
	;	CreatePropertyConditionEx(propertyId,value,flags)
	...
	;	conditions := CreateAndCondition(CreatePropertyCondition(AutomationElement.IsEnabledProperty,true),CreatePropertyCondition(AutomationElement.ControlTypeProperty,ControlType.Button))
	;	windowElement.FindAll(TreeScope_Descendants,conditions)
